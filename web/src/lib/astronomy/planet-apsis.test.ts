...
describe('planet-apsis', () => {
  describe('calculateSolarFluxBoost', () => {
    ...
    it('should calculate Mars perihelion boost correctly', () => {
      ...
      const result = calculateSolarFluxBoost(1.38, 1.524);
  ...
  describe('isNearPerihelion', () => {
    it('should return correct structure', () => {
      ...
      expect(result).toHaveProperty('solarFluxBoostPercent');
      expect(typeof result.isNear).toBe('boolean');
      expect(typeof result.daysUntil).toBe('number');
      expect(typeof result.solarFluxBoostPercent).toBe('number');
    });
