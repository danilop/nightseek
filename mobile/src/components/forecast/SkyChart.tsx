// Native fork of web/src/components/forecast/SkyChart.tsx.
//
// Identical to the web version except that d3 and d3-celestial (and their data
// files) are loaded from the bundle under /vendor instead of unpkg.com, so the
// sky map works with no network. Keep it in step with the web file.
import {
  AlertTriangle,
  ChevronDown,
  ChevronRight,
...
import SkyLayerToggle from '@/components/forecast/SkyLayerToggle';
